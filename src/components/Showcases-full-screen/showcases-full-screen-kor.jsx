...
import ShowcassesFullScreenDataKor from "../../data/showcases-full-screen-slider-kor.json";
import SwiperCore, {
  Navigation,
  Pagination,
  Parallax,
      ...
      <div className="swiper-container parallax-slider">
        {!load ? (
          <Swiper
            ...
            slidesPerView={1}
          >
            {ShowcassesFullScreenDataKor.map((slide) => (
...
export default ShowcasesFullScreenKor;
