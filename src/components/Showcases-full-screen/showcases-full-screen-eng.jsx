...
import ShowcassesFullScreenDataEng from "../../data/showcases-full-screen-slider-eng.json";
import SwiperCore, {
  Navigation,
  Pagination,
  Parallax,
      ...
      <div className="swiper-container parallax-slider">
        {!load ? (
          <Swiper
            ...
            slidesPerView={1}
          >
            {ShowcassesFullScreenDataEng.map((slide) => (
...
export default ShowcasesFullScreenEng;
